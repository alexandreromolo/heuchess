...
public class SugiyamaLayoutConfigurationDialog extends javax.swing.JDialog {
    ...
    private void action_ok() {
        try {
			...
			String message = "Spacing must be numbers";
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        finishedButton.setText("OK");
        finishedButton.setName("OK");
        ...
        jLabel1.setText("Horizontal Spacing");
        jLabel1.setName("HorizontalSpacing");
        jPanel1.add(jLabel1);
        jPanel1.add(horizontalSpacingTextField);

        jLabel2.setText("Vertical Spacing");
        jLabel2.setName("VerticalSpacing");
        jPanel1.add(jLabel2);
