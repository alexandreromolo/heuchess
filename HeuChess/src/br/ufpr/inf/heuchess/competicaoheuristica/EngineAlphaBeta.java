...
public class EngineAlphaBeta extends EngineAnalise {
    ...
    public EngineAlphaBeta(final Avaliador avaliador, int profundidade, ArquivoLog arquivoLog) {
     ...
     */
    private double alphaBetaMin(final Tabuleiro tabuleiro, final int profundidade, final double alpha, double beta) throws Exception {
        ...
        if (profundidade == 0) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMin - Profundidade Final " + (profundidadeBusca - profundidade));                
            }
        ...
        if (tabuleiro.podeEmpatar50Movimentos()) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMin - Empate por 50 Movimentos " + (profundidadeBusca - profundidade));                
            }
        ...
        if (tabuleiro.podeEmpatarTriplaRepeticao()) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMin - Empate por Tripla Repetição " + (profundidadeBusca - profundidade));                
            }
        ...
        if (movimentos.length == 0) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMin - Nenhum Movimento válido " + (profundidadeBusca - profundidade));                
            }
        ...
        for (final Lance movimento : movimentos) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMin - Profundidade " + (profundidadeBusca - profundidade) + 
                                            " Movimento " + movimento + " Novo Estado [" + tabuleiro.getFEN() + "]");
            }
            
            lanceTree.add(movimento);
                        
            final double avaliacao = alphaBetaMax(novoEstado, profundidade - 1, alpha, beta);
            ...
            if (avaliacao < beta){
                beta = avaliacao; // Beta é o valor mais baixo do jogador Min
            }
        }
     ...
     */
    private double alphaBetaMax(final Tabuleiro tabuleiro, final int profundidade, double alpha, final double beta) throws Exception {
        ...
        if (profundidade == 0) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMax - Profundidade Final " + (profundidadeBusca - profundidade));
            }
        ...
        if (tabuleiro.podeEmpatar50Movimentos()) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMax - Empate por 50 Movimentos " + (profundidadeBusca - profundidade));
            }
        ...
        if (tabuleiro.podeEmpatarTriplaRepeticao()) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMax - Empate por Tripla Repetição " + (profundidadeBusca - profundidade));
            }
        ...
        if (movimentos.length == 0) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMax - Nenhum Movimento válido " + (profundidadeBusca - profundidade));
            }
        ...
        for (final Lance movimento : movimentos) {
            ...
            if (arquivoLog != null){
                arquivoLog.registraMensagem("alphaBetaMax - Profundidade " + (profundidadeBusca - profundidade) + 
                                            " Movimento " + movimento + " Novo Estado [" +  tabuleiro.getFEN() + "]");
            }
            
            lanceTree.add(movimento);
            
            final double avaliacao = alphaBetaMin(novoEstado, profundidade - 1, alpha, beta);
            ...
            if (avaliacao > alpha ){
                alpha = avaliacao; // Alfa é o valor mais alto do jogador Max
            }            
        }
    ...
    public synchronized Lance getProximoLance(final Tabuleiro estadoAtual, final boolean analisarTabuleiroCorBranca) throws Exception {
        ...
        try {
            ...
            if (arquivoLog != null) {
                ...
                arquivoLog.registraMensagem("Iniciando Análise Minimax AlphaBeta para peças " + (estadoAtual.isWhiteActive() ? "Brancas" : "Pretas"));
            ...
            for (final Lance movimento : movimentos) {
                ...
                if (escolherJogadaCorBranca == analisarTabuleiroCorBranca){
                    ...
                    final double valorHeuristico = alphaBetaMin(novoEstado, profundidadeBusca - 1, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
                    ...
                    final double valorHeuristico = alphaBetaMax(novoEstado, profundidadeBusca - 1, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    ...
    public String getDescricao() {
        return "Busca Otimizada - AlphaBeta";
    }
    
    @Override
    public EngineAlphaBeta geraClone(){        
        return new EngineAlphaBeta(avaliador, profundidadeBusca, arquivoLog);
    }
}
